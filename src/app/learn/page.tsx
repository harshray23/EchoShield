...
import { Shield, BookOpen, AlertTriangle, Fingerprint, Lock, Eye, MessageSquare, Zap, CheckCircle } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-8 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {modules.map((module, i) => (
          ...
          >
            <Card className="h-full glass-card border-white/5 rounded-[2rem] overflow-hidden hover:border-primary/30 transition-all flex flex-col">
              <CardHeader className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-primary/10 rounded-2xl text-primary">{module.icon}</div>
              ...
              <CardContent className="p-8 pt-0 flex-1 flex flex-col justify-between">
                ...
                <Button className="w-full rounded-xl bg-white/5 hover:bg-primary hover:text-white border-white/5 font-bold transition-all">Start Module</Button>
              </CardContent>
            </Card>
          </motion.div>
        ))}
      ...
      <section className="bg-primary/5 rounded-[3rem] p-8 md:p-12 border border-primary/10 relative overflow-hidden">
        ...
        <div className="max-w-2xl space-y-6 relative z-10">
          <h2 className="text-3xl font-black tracking-tight">AI Scam Simulation</h2>
          ...
          <Button size="lg" className="rounded-2xl btn-gradient cyber-glow px-8 h-14 text-lg font-black">LAUNCH SIMULATOR</Button>
        </div>
      </section>
    </div>
  );
